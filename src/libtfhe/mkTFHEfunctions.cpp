...
// 函数功能：实现自举的与门
EXPORT void MKbootsAND_FFT_v2m2(MKLweSample *result,                         // 用于存放结果
                                ...
                                const MKRLweKey *MKrlwekey)                 // 输入 MKRLWE 密钥（仅使用公钥部分）
{
    ...
    // cout << "重写 MKAND 完成，耗时： " << time_MKAND << " 秒" << endl;
}


// 函数功能：实现自举的或门
EXPORT void MKbootsOR_FFT_v2m2(MKLweSample *result,                         // 用于存放结果
                                const MKLweSample *ca,                      // 输入密文 ca
                                const MKLweSample *cb,                      // 输入密文 cb
                                const MKLweBootstrappingKeyFFT_v2 *bkFFT,   // 输入 MK 自举密钥
                                const LweParams* LWEparams,                 // 输入 LWE 参数
...
{ 
    ...
    // cout << "重写 MKOR 完成，耗时： " << time_MKOR << " 秒" << endl;
}


// 函数功能：实现自举的非门
EXPORT void MKlweNegate(MKLweSample *result,            // 用于存放结果
                        const MKLweSample *sample,      // 输入密文
                        const MKTFHEParams *MKparams)   // 输入 MK 参数
{
    ...
    // cout << "重写 MKNOT 完成，耗时： " << time_MKNOT << " 秒" << endl;
}



// 函数功能：实现自举的异或门
EXPORT void MKbootsXOR_FFT_v2m2(MKLweSample *result,                         // 用于存放结果
                                const MKLweSample *ca,                      // 输入密文 ca
                                const MKLweSample *cb,                      // 输入密文 cb
                                const MKLweBootstrappingKeyFFT_v2 *bkFFT,   // 输入 MK 自举密钥
                                const LweParams* LWEparams,                 // 输入 LWE 参数
                                ...
                                const MKRLweKey *MKrlwekey)                 // 输入 MKRLWE 密钥（仅使用公钥部分）
{
    ...
    // cout << "重写 MKXOR 完成，耗时： " << time_MKXOR << " 秒" << endl;
}
